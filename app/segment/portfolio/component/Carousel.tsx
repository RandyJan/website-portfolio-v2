            ...
            <CardContent className="h-full p-0">
              <div className="flex h-full flex-col bg-gradient-to-b from-white to-slate-50 dark:from-slate-950 dark:to-slate-900">
                ...
                <div className="flex h-full flex-col p-6">
                  <div className="grow">
                    <p className="break-words text-2xl font-semibold text-slate-950 dark:text-white">
                      {project.name}
                    </p>

                    <div className="mt-3 flex items-start gap-2 text-sm text-sky-700 dark:text-sky-300">
                      <FontAwesomeIcon icon={faLayerGroup} className="mt-1 shrink-0" />
                  ...
                  <div className="mt-6 flex flex-row flex-wrap items-center justify-center gap-3">
                    {!Array.isArray(project.source_code) && project.source_code ? (
                      <a
                        ...
                        target="_blank"
                        className="inline-flex h-10 w-10 items-center justify-center text-sky-500 enlarge"
                      ...
                      <FontAwesomeIcon
                        icon={faGithub}
                        size="2xl"
                        className="h-10 w-10 cursor-pointer text-sky-500 enlarge"
                        onClick={() => {
                    ...
                    <button
                      ...
                      className={`flex min-h-10 items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-all duration-300 enlarge ${
                        is_dark
